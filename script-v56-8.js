...
// V56.8 - Lưu nhiều NGÀY ĐƠN trong cột selected_statuses hiện có để không cần đổi SQL.
...
/* ======================== SUPABASE CLOUD ======================== */
const APP_VERSION = "V56.8";
const APP_BUILD_DATE = "2026-08-17";
const APP_CACHE_VERSION = "568";
...
async function runSystemHealthCheckV38({ silent = false } = {}) {
    ...
    systemHealthStateV38.checks = [
        v38HealthCheckItem(
            ...
            (
                document.querySelector('link[href*="style-v56-8.css"]')?.getAttribute("href")?.includes(`v=${APP_CACHE_VERSION}`) &&
                document.querySelector('script[src*="script-v56-8.js"]')?.getAttribute("src")?.includes(`v=${APP_CACHE_VERSION}`)
            )
                ? "ok"
                : "warning",
            (
                ...
                ? `index.html đang gọi đúng style-v56-8.css?v=${APP_CACHE_VERSION} và script-v56-8.js?v=${APP_CACHE_VERSION}.`
                : `Chưa tải đúng bộ file V56.8. Hãy kiểm tra index.html, style-v56-8.css và script-v56-8.js.`
        ),
...
// V56.8: nếu trình duyệt tự reload/tab bị discard rồi mở lại, trả đúng vị trí đang xem.
