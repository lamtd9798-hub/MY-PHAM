...
async function runSystemHealthCheckV38({ silent = false } = {}) {
    ...
    systemHealthStateV38.checks = [
        v38HealthCheckItem(
            ...
            (
                document.querySelector('link[href*="style-v57.css"]')?.getAttribute("href")?.includes(`v=${APP_CACHE_VERSION}`) &&
                document.querySelector('script[src*="script-v57.js"]')?.getAttribute("src")?.includes(`v=${APP_CACHE_VERSION}`)
            )
                ? "ok"
                : "warning",
            (
                ...
                ? `index.html đang gọi đúng style-v57.css?v=${APP_CACHE_VERSION} và script-v57.js?v=${APP_CACHE_VERSION}.`
                : `Chưa tải đúng bộ file V57.0. Hãy kiểm tra index.html, style-v57.css và script-v57.js.`
        ),
