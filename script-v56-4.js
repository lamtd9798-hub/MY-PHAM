...
/* ======================== SUPABASE CLOUD ======================== */
const APP_VERSION = "V56.4";
const APP_BUILD_DATE = "2026-08-15";
const APP_CACHE_VERSION = "564";
...
async function runSystemHealthCheckV38({ silent = false } = {}) {
    ...
    systemHealthStateV38.checks = [
        v38HealthCheckItem(
            ...
            (
                document.querySelector('link[href*="style-v56-4.css"]')?.getAttribute("href")?.includes(`v=${APP_CACHE_VERSION}`) &&
                document.querySelector('script[src*="script-v56-4.js"]')?.getAttribute("src")?.includes(`v=${APP_CACHE_VERSION}`)
            )
                ? "ok"
                : "warning",
            (
                ...
                ? `index.html đang gọi đúng style-v56-4.css?v=${APP_CACHE_VERSION} và script-v56-4.js?v=${APP_CACHE_VERSION}.`
                : `Chưa tải đúng bộ file V56.4. Hãy kiểm tra index.html, style-v56-4.css và script-v56-4.js.`
        ),
